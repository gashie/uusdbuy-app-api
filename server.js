...
app.listen(PORT, () => {
    console.log(
        `USSD-BUY App: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`
    );
    logger.debug(`USSD-BUY App: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`);
});
